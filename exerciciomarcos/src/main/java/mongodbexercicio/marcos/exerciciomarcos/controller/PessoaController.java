...
public class PessoaController {
    ...
    @PostMapping
    public Pessoa criar(@RequestBody Pessoa pessoa){return this.pessoaService.criar(pessoa);}
    @ResponseStatus(HttpStatus.NO_CONTENT)
    @DeleteMapping("/{codigo}")
    public Pessoa deletar(@RequestBody Pessoa pessoa){return this.pessoaService.deletar(pessoa);
    }
    @ResponseStatus(HttpStatus.NO_CONTENT)
    @PutMapping("/{codigo}")
